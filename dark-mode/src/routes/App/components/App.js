  ...
  return (
    <div className={`app ${isDark ? "dark-mode": ""}`  }>
      <div className="level">
        ...
        <button className="app__dark-mode-btn icon level-right" onClick={() => setDark(!isDark)} >
          { isDark ? (<FontAwesomeIcon color="#FFA500" icon={faSun} />) : (<FontAwesomeIcon icon={faMoon} />)}</button>
      </div>
